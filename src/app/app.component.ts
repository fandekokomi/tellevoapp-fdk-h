...
export class AppComponent {
  ...
  configSideMenu() {
    if (this.tipousuario === 'admin') {
    ...
    } else if (this.tipousuario === 'chofer'){
      this.descripcion = "Menú del chofer";
      this.appPages = [
        { title: 'Home', icono: 'home', action: () => this.router.navigate(['/home']) },
        { title: 'Programar Viaje', icono: 'map', action: () => this.router.navigate(['/programar-viaje']) },
      ...
      this.appPages = [
        { title: 'Home', icono: 'home', action: () => this.router.navigate(['/home']) },
        { title: 'Escaner', icono: 'qr-code', action: () => this.router.navigate(['/qr-scan'])},
        { title: 'Viajes disponibles', icono: 'car', action: () => this.router.navigate(['/viajes-disponibles']) },
        { title: 'Perfil', icono: 'person-circle', action: () => this.router.navigate(['/perfil']) },
        { title: 'Cerrar Sesión', action: () => this.logout(), icono: 'log-out' },
      ];
    }
